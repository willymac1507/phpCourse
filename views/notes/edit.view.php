      ...
      <div class="space-y-10 divide-y divide-gray-900/10">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
          <div class="px-4 sm:px-0">
            <p class="mt-1 text-sm leading-6 text-gray-600">Edit or delete your note here.</p>
          </div>

          <form method="post" action="/note" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl
          md:col-span-2">
              ...
              <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    ...
                    focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?= $note['body'] ?? $_POST['body']
                        ?></textarea>
