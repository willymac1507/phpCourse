          ...
          <form class="space-y-6" action="/register" method="POST">
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <p class="font-semibold text-indigo-600 hover:text-indigo-500">Min 8 characters</p>
                </div>
              </div>
              <div class="mt-2">
            ...
            <div>
              <div class="flex items-center justify-between">
                <label for="repeatPassword" class="block text-sm font-medium leading-6 text-gray-900">Repeat
                  Password</label>
              </div>
              <div class="mt-2">
              ...
              <div class="mt-2">
                  <?php if (isset($errors['repeatPassword'])) : ?>
                    <p class="text-red-500 text-xs mt-2"><?= $errors['repeatPassword'] ?></p>
                  <?php endif; ?>
              </div>
            </div>
            ...
            <div>
              ...
              focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
            </div>
          </form>
